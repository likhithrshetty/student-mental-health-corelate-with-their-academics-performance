...
{
    public partial class _MLModel : System.Web.UI.Page
    {
                ...
                if (tabData.Rows.Count > 0)
                {
                    ...
                    for (int i = 0; i < tabData.Rows.Count; i++)
                    {
                        string _data = tabData.Rows[i]["Gender"].ToString() + "," +
                            ...
                            tabData.Rows[i]["Fear"].ToString() + "," +
                            tabData.Rows[i]["Anxiety"].ToString() + "," +
                            tabData.Rows[i]["Obsession"].ToString() + "," +
                            tabData.Rows[i]["Paranoid"].ToString() + "," +
                            tabData.Rows[i]["Nervousness"].ToString() + "," +
                            tabData.Rows[i]["injury"].ToString() + "," +
                            tabData.Rows[i]["Interpersonal sensitivity"].ToString() + "," +
                            tabData.Rows[i]["Stage fear"].ToString() + "," +
                            tabData.Rows[i]["Stress"].ToString();
